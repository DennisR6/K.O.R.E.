...
export const MAP_CATALOG: readonly MapCatalogEntry[] = [
	{
		...
		knownLimitations: [
			"Shipped local-match arena; technically qualified by the 17.7 matrix evidence",
	...
	},
	{
		...
		status: "technically-qualified",
		knownLimitations: [
			"Blocked-from-selection in the gameplay content registry; browser run pending 17.8",
