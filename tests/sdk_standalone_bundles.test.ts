...
test("standalone bundles preserve runtime public export names", async () => {
	...
	expect(Object.keys(engineBundle).sort()).toEqual(["EngineEffectRegistry", "EngineSystemRegistry", "EngineTriggerActivationQueue", "EngineWorldBuilder", "MOVEMENT_CAPABILITY", "MOVEMENT_EFFECT_ID", "TRANSFORM_CAPABILITY", "TRANSFORM_SET_POSITION_EFFECT_ID", "TRANSFORM_SET_ROTATION_EFFECT_ID", "createCollisionEnterTriggerEvent", "createEnvironmentActivationTriggerEvent", "createMovementState", "createRoundStartTriggerEvent", "createScheduleDueTriggerEvent", "createTickTriggerEvent", "createTransformState", "createTriggerActivation", "engine", "registerMovementEffect", "registerTransformEffects", "validateMovementState", "validateTransformState", "validateTriggerActivation", "validateTriggerEvent"].sort());
