...
| 45 | `[ ]` | `milestone-45-competitive-map-pack` | — | [`steps/45-sdk_authored_competitive_map_pack.md`](steps/45-sdk_authored_competitive_map_pack.md) | SDK-Authored Competitive Map Pack | Add at least three production maps through the public KORE map SDK with fingerprints, spawn validity, fairness, AI, replay, repository, and browser qualification. |
...
| 49 | `[ ]` | `milestone-49-content-cross-system-qualification` | — | [`steps/49-new_content_cross_system_qualification.md`](steps/49-new_content_cross_system_qualification.md) | New Content Cross-System Qualification | Qualify content from Milestones 41–48 across determinism, AI, replay, restore, persistence, repositories, reconnect, browser, desktop, and mod validation. |
| 50 | `[ ]` | `milestone-50-sdk-content-release-gate` | — | [`steps/50-sdk_authored_content_release_gate.md`](steps/50-sdk_authored_content_release_gate.md) | SDK-Authored Content Release Gate | Final technical, deterministic, browser, packaging, documentation, and human-playtest-status gate for the new SDK-authored content set. |
