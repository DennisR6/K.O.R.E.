...
// 	]
// 	const players = [
// 		new Player().new({ position: { x: 100, y: 120 }, id: "a3b4edd5-1e04-47ac-85c2-af5fbfcd3f0f", size: 20, color: "red", team: [0] }),
// 		new Player().new({ position: { x: 200, y: 200 }, id: "7527447c-6a35-4a72-98f6-09c1f2d2cd8f", size: 20, color: "cyan", team: [1] }),
// 	]
...
// 	const MAX_DRIFT = 10
// 	const players = sim.finalState.map(player => { return { id: player.id, x: player.position.x, y: player.position.y } })
