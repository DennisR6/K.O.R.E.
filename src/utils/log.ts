...
// 	}
//
// 	private getColor(level: keyof typeof LogLevel): string {
// 		switch (level) {
...
// 	public info(...a: any[]) { this.log(LogLevel.INFO, ...a); }
//
// 	/** Loggt einen Fehler (Rot) - Sollte für kritische Probleme genutzt werden. */
// 	public error(...a: any[]) { this.log(LogLevel.ERROR, ...a); }
//
// 	/** 
// 	 * Loggt Debug-Informationen (Grün). 
// 	 * Ideal für Physik-Werte oder State-Changes während der Entwicklung.
// 	 */
// 	public debug(...a: any[]) { this.log(LogLevel.DEBUG, ...a); }
// 	public trace(...a: any[]) { this.log(LogLevel.TRACE, ...a); }
// }
