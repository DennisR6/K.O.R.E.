...
| 43 | `[ ]` | `milestone-43-animation-presentation-sdk` | — | [`steps/43-deterministic_animation_and_presentation_sdk.md`](steps/43-deterministic_animation_and_presentation_sdk.md) | Deterministic Animation And Presentation SDK | Add renderer-independent, data-driven animation settings and semantic presentation events while keeping visual state outside canonical gameplay snapshots. |
