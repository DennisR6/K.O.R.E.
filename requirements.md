...
| R-03 | TODO Phase 2 movement and drift; GDD 5 | [Physics](step-by-step.md#2-deterministic-physics-and-arena-safety) | `tests/effect_test.ts` covers movement/friction and stop behavior; `tests/map_drift_settings.test.ts` covers valid and invalid map drift factors. | Map friction injection, drift steering, and fixed-seed final-position regression fixtures. |
