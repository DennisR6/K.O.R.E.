...
| magma-cradle | Magma Cradle | `src/settings/magmaCradleMap.ts` | 1 | scalable (800x450) | symmetric | 2 | 8 (7 solids + 1 containment rect, Task 17.3) | 2 force-vents, 6 kill-zones including four corner zones | tiles | 0 | 2 teams, 1/2/6 figures | yes (menu selectable) | browser-qualified | stock hard AI may not seek lethal hazards (17.6 policy note) |
