...
export const legacyAuthoringPaths: readonly LegacyAuthoringPath[] = [
	{ path: "src/scenes/matchPipeline.ts", symbol: "createMatchHandler", kind: "construction", classification: "removal-candidate", owner: "Legacy match composition", targetMilestone: 28, note: "Constructs GameHandlerBuilder, WinningSystem, UiSystem, emitters, and AI systems directly." },
	{ path: "src/settings/canonicalPlayableMatch.ts", symbol: "createCanonicalPlayableMatchSettings", kind: "configuration", classification: "removal-candidate", owner: "Legacy match configuration", targetMilestone: 28, note: "Configures teams, rules, items, boundaries, and canonical settings directly." },
