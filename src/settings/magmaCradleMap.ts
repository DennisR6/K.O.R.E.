...
export function createMagmaCradleMap(worldSize: Vector2D): MapDocument {
	...
	return rect(66, 90, 10, 270)
	.addRectangle({ x: 105 * scaleX, y: 55 * scaleY, w: 270 * scaleX, h: 10 * scaleY ,color: "#ff000000"})
	.addRectangle({ x: 425 * scaleX, y: 55 * scaleY, w: 270 * scaleX, h: 10 * scaleY ,color: "#09ee4e00"})
	.addRectangle({ x: 105 * scaleX, y: 385 * scaleY, w: 270 * scaleX, h: 10 * scaleY ,color: "#ebdc0600"})
	.addRectangle({ x: 425 * scaleX, y: 385 * scaleY, w: 270 * scaleX, h: 10 * scaleY ,color: "#071de400"})
	.addRectangle({ x: 723 * scaleX, y: 90 * scaleY, w: 10 * scaleX, h: 270 * scaleY ,color: "#f700ff00"})
	.addRectangle({ x: 400 * scaleX, y: 150 * scaleY, w: 10 * scaleX, h: 150 * scaleY ,color: "#07d4f800"})
	.addForceZone({ id: "west-vent", x: 300 * scaleX, y: 225 * scaleY, r: 28 * scale, angle: 0, power: 4 })
	.addForceZone({ id: "east-vent", x: 500 * scaleX, y: 225 * scaleY, r: 28 * scale, angle: 180, power: 4 })
	.addKillZone({ id: "north-lava", x: 400 * scaleX, y: 43 * scaleY, r: 20 * scale })
	.addKillZone({ id: "south-lava", x: 400 * scaleX, y: 406 * scaleY, r: 20 * scale })
	.addKillZone({ id: "north-west-corner-lava", x: 72 * scaleX, y: 57 * scaleY, r: 20 * scale })
	.addKillZone({ id: "north-east-corner-lava", x: 728 * scaleX, y: 57 * scaleY, r: 20 * scale })
	.addKillZone({ id: "south-west-corner-lava", x: 72 * scaleX, y: 390 * scaleY, r: 20 * scale })
	.addKillZone({ id: "south-east-corner-lava", x: 728 * scaleX, y: 390 * scaleY, r: 20 * scale })
	.buildMapDocument();
}
