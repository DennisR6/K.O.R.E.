...
| 32 | `[-]` | `milestone-32-input-commands-actions` | — | [`steps/32-migration_input_commands_and_actions.md`](steps/32-migration_input_commands_and_actions.md) | Migration Input, Commands, And Actions | In progress: shared KORE input bindings and validated semantic command routing for keyboard, controller, touch, and gameplay adapters. |
