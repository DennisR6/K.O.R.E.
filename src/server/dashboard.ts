...
function renderReplayTable(response: DashboardReplayIndexResponse, publicBaseUrl?: string): string {
	...
	return `<table id="replay-table"><caption>Persisted match replays</caption><thead><tr><th>Match ID</th><th>Status</th><th>Updated</th><th>Actions</th><th>Replay</th></tr></thead><tbody data-replays="index">${rows}</tbody></table>`;
}
