...
test("standalone bundles preserve runtime public export names", async () => {
	...
	expect(Object.keys(engineBundle).sort()).toEqual(["EngineEffectRegistry", "EngineSystemRegistry", "EngineWorldBuilder", "MOVEMENT_CAPABILITY", "MOVEMENT_EFFECT_ID", "createMovementState", "createTransformState", "engine", "registerMovementEffect", "validateMovementState", "validateTransformState"].sort());
