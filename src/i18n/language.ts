...
export const LANGUAGE_KEYS = {
	...
	MenuPlaytestButton: "kore.ui.menu.playtestButton",
	MenuPlaytestTitle: "kore.ui.menu.playtestTitle",
	MenuPlaytestInstructions: "kore.ui.menu.playtestInstructions",
	MenuPlaytestStart: "kore.ui.menu.playtestStart",
...
const EN_EN_STRINGS: Record<LanguageKey, string> = {
	...
	[LANGUAGE_KEYS.MenuPlaytestButton]: "Human Playtest",
	[LANGUAGE_KEYS.MenuPlaytestTitle]: "Human Playtest",
	[LANGUAGE_KEYS.MenuPlaytestInstructions]: "Play one complete match. Your match result and performance are recorded automatically. Afterward, share what felt good or confusing.",
	[LANGUAGE_KEYS.MenuPlaytestStart]: "Start Playtest",
