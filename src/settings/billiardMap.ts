...
// 		//
// 		//
// 		{ type: SHAPE.RECTANGLE, x: 45, y: 75, w: thickness, h: 300, color: debugColorStruct },
// 		{ type: SHAPE.RECTANGLE, x: 75, y: 45, w: 300, h: thickness, color: debugColorStruct },
// 		{ type: SHAPE.RECTANGLE, x: 425, y: 45, w: 300, h: thickness, color: debugColorStruct },
// 		{ type: SHAPE.RECTANGLE, x: 75, y: 405, w: 300, h: thickness, color: debugColorStruct },
// 		{ type: SHAPE.RECTANGLE, x: 425, y: 405, w: 300, h: thickness, color: debugColorStruct },
// 		{ type: SHAPE.RECTANGLE, x: 800 - 45, y: 75, w: thickness, h: 300, color: debugColorStruct },
// 		{ type: SHAPE.RECTANGLE, x: x / 2, y: y / 3, w: thickness, h: y / 3, color: "black" },
//
// 		{ type: SHAPE.CIRCLE, x: offset + CircleRadius, y: offset + CircleRadius, r: CircleRadius, color: debugColorStruct },
// 		{ type: SHAPE.CIRCLE, x: x / 2, y: offset + 5, r: CircleRadius, color: debugColorStruct },
// 		{ type: SHAPE.CIRCLE, x: (x - offset - CircleRadius), y: offset + CircleRadius, r: CircleRadius, color: debugColorStruct },
// 		{ type: SHAPE.CIRCLE, x: offset + 10, y: 408, r: CircleRadius, color: debugColorStruct },
// 		{ type: SHAPE.CIRCLE, x: x / 2, y: 413, r: CircleRadius, color: debugColorStruct },
// 		{ type: SHAPE.CIRCLE, x: 760, y: 408, r: CircleRadius, color: debugColorStruct },
// 	],
