...
| R-06 | TODO Grundprinzip, Phase 5, and Phase 6; GDD 6, 7, and 12 | [Data Contracts](step-by-step.md#4-data-contracts-mods-and-maps) | `tests/document_versions.test.ts` covers version-one migration; `tests/setting_effect.test.ts` and `tests/authoritative_game.test.ts` cover selected serialization boundaries. | Strict validators, rejected untrusted data, and effect-whitelist tests. |
