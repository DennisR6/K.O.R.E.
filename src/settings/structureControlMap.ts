...
export function createStructureControlMap(worldSize: Vector2D): MapDocument {
	...
	return map
		.addRectangle({ x: 300 * scaleX, y: 70 * scaleY, w: 16 * scaleX, h: 80 * scaleY })
		.addRectangle({ x: 300 * scaleX, y: 300 * scaleY, w: 16 * scaleX, h: 80 * scaleY })
		.addRectangle({ x: 484 * scaleX, y: 70 * scaleY, w: 16 * scaleX, h: 80 * scaleY })
		.addRectangle({ x: 484 * scaleX, y: 300 * scaleY, w: 16 * scaleX, h: 80 * scaleY })
		.addRectangle({ x: 392 * scaleX, y: 213 * scaleY, w: 16 * scaleX, h: 24 * scaleY })
		.buildMapDocument();
}
