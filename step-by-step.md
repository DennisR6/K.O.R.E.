...
| 31 | `[-]` | `milestone-31-ui-scenes-surfaces` | — | [`steps/31-migration_ui_scenes_and_gameplay_surfaces.md`](steps/31-migration_ui_scenes_and_gameplay_surfaces.md) | Migration UI Scenes And Gameplay Surfaces | In progress: SDK-authored replay viewer composition and browser adapter; operator HTML remains an explicit server adapter. |
