...
| 30 | `[-]` | `milestone-30-items-loadouts-effects` | — | [`steps/30-migration_items_loadouts_and_effect_composition.md`](steps/30-migration_items_loadouts_and_effect_composition.md) | Migration Items, Loadouts, And Effect Composition | In progress: validated KORE item authoring and SDK-owned item economy composition. |
