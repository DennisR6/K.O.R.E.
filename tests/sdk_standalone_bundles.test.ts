...
test("standalone bundles preserve runtime public export names", async () => {
	...
	expect(Object.keys(engineBundle).sort()).toEqual(["EngineEffectRegistry", "EngineSystemRegistry", "EngineTriggerActivationQueue", "EngineWorldBuilder", "MOVEMENT_CAPABILITY", "MOVEMENT_EFFECT_ID", "createCollisionEnterTriggerEvent", "createEnvironmentActivationTriggerEvent", "createMovementState", "createRoundStartTriggerEvent", "createTickTriggerEvent", "createTransformState", "createTriggerActivation", "engine", "registerMovementEffect", "validateMovementState", "validateTransformState", "validateTriggerActivation", "validateTriggerEvent"].sort());
	...
	expect(Object.keys(koreBundle).sort()).toEqual(["KoreMapBuilder", "applyRuntimeForceEffects", "composeItemEffects", "createDefaultKoreFramework", "createEntityResolvedTarget", "createItem", "createPlayer", "createPositionResolvedTarget", "createRuntimeItemEffect", "kore", "resolveRuntimeItemEffects", "validateResolvedEffectTarget"].sort());
});
