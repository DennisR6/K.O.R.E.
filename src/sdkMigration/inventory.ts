...
export const sourceClassificationRules: readonly SdkMigrationEntry[] = [
	...
	{ path: "src/kore/runtime/", classification: "runtime-factory", owner: "KORE runtime composition", targetMilestone: null, note: "KORE match orchestration, rendering runtime, and reconstruction adapters; generic Engine SDK code must not import this layer." },
	...
	{ path: "src/kore/presentation.ts", classification: "kore-sdk", owner: "KORE Presentation", targetMilestone: 44, note: "KORE semantic presentation vocabulary." },
	{ path: "src/kore/gameplayFeedback.ts", classification: "kore-sdk", owner: "KORE Gameplay Feedback", targetMilestone: 44, note: "Authoritative semantic feedback trace and renderer/audio adapters." },
	...
	{ path: "src/kore/runtime/runtimeFactory.ts", classification: "runtime-factory", owner: "Handler runtime factory", targetMilestone: null, note: "Only permitted GameHandler construction boundary for canonical match creation (milestone 28)." },
...
export const legacyAuthoringPaths: readonly LegacyAuthoringPath[] = [
	...
	{ path: "src/kore/runtime/Handler.ts", symbol: "simulateTurn/fromSettings", kind: "deserialization", classification: "runtime-factory", owner: "Handler runtime boundary", targetMilestone: 28, note: "Restores isolated handlers from canonical snapshots; construction is internal runtime work." },
