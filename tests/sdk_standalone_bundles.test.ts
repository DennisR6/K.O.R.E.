...
test("standalone bundles preserve runtime public export names", async () => {
	...
	expect(Object.keys(engineBundle).sort()).toEqual(["COUNTER_ADD_EFFECT_ID", "COUNTER_CAPABILITY", "COUNTER_RESET_EFFECT_ID", "COUNTER_SCHEMA_VERSION", "COUNTER_SET_EFFECT_ID", "EngineEffectRegistry", "EngineSystemRegistry", "EngineTriggerActivationQueue", "EngineWorldBuilder", "MOVEMENT_ADD_VELOCITY_EFFECT_ID", "MOVEMENT_CAPABILITY", "MOVEMENT_EFFECT_ID", "MOVEMENT_SCALE_SPEED_EFFECT_ID", "MOVEMENT_SET_VELOCITY_EFFECT_ID", "TRANSFORM_CAPABILITY", "TRANSFORM_SET_POSITION_EFFECT_ID", "TRANSFORM_SET_ROTATION_EFFECT_ID", "canonicalizeCounterStates", "counterTriggerMatches", "createCollisionEnterTriggerEvent", "createCounterState", "createEnvironmentActivationTriggerEvent", "createMovementState", "createRoundStartTriggerEvent", "createScheduleDueTriggerEvent", "createTickTriggerEvent", "createTransformState", "createTriggerActivation", "engine", "registerCounterCommands", "registerMovementCommands", "registerMovementEffect", "registerTransformEffects", "validateCounterEffectSettings", "validateCounterState", "validateCounterTarget", "validateCounterTriggerBinding", "validateMovementState", "validateTransformState", "validateTriggerActivation", "validateTriggerEvent"].sort());
