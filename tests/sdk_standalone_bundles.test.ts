...
test("standalone bundles preserve runtime public export names", async () => {
	...
	expect(Object.keys(engineBundle).sort()).toEqual(["COUNTER_ADD_EFFECT_ID", "COUNTER_CAPABILITY", "COUNTER_EFFECT_IDS", "COUNTER_RESET_EFFECT_ID", "COUNTER_SCHEMA_VERSION", "COUNTER_SET_EFFECT_ID", "EngineEffectRegistry", "EngineSystemRegistry", "EngineTriggerActivationQueue", "EngineWorldBuilder", "MOVEMENT_ADD_VELOCITY_EFFECT_ID", "MOVEMENT_CAPABILITY", "MOVEMENT_COMMAND_EFFECT_IDS", "MOVEMENT_EFFECT_ID", "MOVEMENT_SCALE_SPEED_EFFECT_ID", "MOVEMENT_SET_VELOCITY_EFFECT_ID", "TRANSFORM_CAPABILITY", "TRANSFORM_SET_POSITION_EFFECT_ID", "TRANSFORM_SET_ROTATION_EFFECT_ID", "canonicalizeCounterStates", "counterSystemDefinition", "counterTriggerMatches", "createCollisionEnterTriggerEvent", "createCounterState", "createEnvironmentActivationTriggerEvent", "createMovementState", "createRoundStartTriggerEvent", "createScheduleDueTriggerEvent", "createTickTriggerEvent", "createTransformState", "createTriggerActivation", "engine", "movementSystemDefinition", "registerCounterCommands", "registerCounterSystem", "registerMovementCommands", "registerMovementEffect", "registerMovementSystem", "registerTransformEffects", "validateCounterEffectSettings", "validateCounterState", "validateCounterTarget", "validateCounterTriggerBinding", "validateMovementState", "validateTransformState", "validateTriggerActivation", "validateTriggerEvent"].sort());
