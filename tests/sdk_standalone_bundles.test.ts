...
test("standalone bundles preserve runtime public export names", async () => {
	...
	expect(Object.keys(koreBundle).sort()).toEqual(["KoreMapBuilder", "applyRuntimeForceEffects", "composeItemEffects", "createDefaultKoreFramework", "createItem", "createPlayer", "createRuntimeItemEffect", "kore", "resolveRuntimeItemEffects"].sort());
});
