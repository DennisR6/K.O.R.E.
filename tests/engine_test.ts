...
test("engine", () => {
	...
	handler.tick(1)
	expect(player1.getPos().x).toBeCloseTo(30, 10)
	expect(player1.getPos().y).toBeCloseTo(40, 10)
	handler.tick(2)
	expect(player1.getPos().x).toBeCloseTo(50, 10)
	expect(player1.getPos().y).toBeCloseTo(80, 10)
	handler.tick(1)
	expect(player1.getPos().x).toBeCloseTo(60, 10)
	expect(player1.getPos().y).toBeCloseTo(100, 10)
	handler.tick(1)
	expect(player1.getPos().x).toBeCloseTo(70, 10)
	expect(player1.getPos().y).toBeCloseTo(120, 10)
})
